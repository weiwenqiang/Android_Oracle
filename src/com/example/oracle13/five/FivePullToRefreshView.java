...
public class FivePullToRefreshView extends LinearLayout {
	...
	public FivePullToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public FivePullToRefreshView(Context context) {
		super(context);
		init();
	}
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.five_refresh_header, this, false);
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.five_refresh_footer, this, false);
