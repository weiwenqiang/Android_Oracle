...
public class ItemList {
	...
	public String toString() {
		return "ItemList [title=" + title + ", brief=" + brief + ", phoneImg="
	...
	public ItemList(String title, String brief, String phoneImg, String padImg,
			String itemType, String itemID, String detailUrl, String order) {
		super();
		this.title = title;
		this.brief = brief;
